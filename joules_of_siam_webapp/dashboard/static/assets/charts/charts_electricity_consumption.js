var charts_doughnut_electricity_consumption = document.getElementById('Charts_Doughnut_Electricity_Consumption').getContext('2d');
...
fetch('/_get_charts_electricity_consumption_graph/')
    .then(response => response.json())
    .then(data => {
      new Chart(charts_doughnut_electricity_consumption, {
        type: 'doughnut',
        data: {
          labels: data.labels,
          datasets: [{
